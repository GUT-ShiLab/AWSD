...
import os
import pdb
output_dir = os.path.join("plots", "average F1 plots DIABIMMUNE")
...
pd.DataFrame(all_rows, columns=columns).to_excel(f'plots/plots results/{plot_type}_results.xlsx')
...
for pth in os.listdir('plots/average F1 plots/'):
    ...
    # pdb.set_trace()
    validation_f1 = result['mean']['validation auc']
